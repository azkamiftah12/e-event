import { createStyles, Header, HoverCard, Group, Button, UnstyledButton, Text, SimpleGrid, ThemeIcon, Anchor, Divider, Center, Box, rem } from '@mantine/core';
...
export default function HeaderMenu() {
  ...
  return (
    <Box>
      <Header height={75} px="md" style={{ backgroundColor: '#3F2661', margin: -5, border: 'none' }}>
